...
| WP4 | TASK-003 | `lis-crs-spec-ack-svc` | **Checks, relabel, send-out** — hard/soft checks; Relabel; `LOE_SENDOUT_TEST`; mixed → Failure | `[ ]` | [[WP4 — Checks, relabel, send-out]] · needs WP1 check/relabel/send-out interfaces and WP3 packing · XL · 10d · `TASK-003` |
...
| 2026-09-21 | Linked TASK-003 to [[WP4 — Checks, relabel, send-out]] |
