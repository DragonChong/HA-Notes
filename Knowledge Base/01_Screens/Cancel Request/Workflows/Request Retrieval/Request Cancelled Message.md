...
> **ANAT override:** For ANAT (Anatomical Pathology) requests, `AMEND_CANCEL_COMMENT` is always treated as disabled for already-cancelled requests, regardless of the lab option setting. See [[Special Lab Workflow/ANAT/Object Enablement After Retrieval (ANAT)|Object Enablement After Retrieval (ANAT)]] for details.
...
- [[Special Lab Workflow/ANAT/Object Enablement After Retrieval (ANAT)|Object Enablement After Retrieval (ANAT)]] — The ANAT-specific override that unconditionally blocks amending a cancelled request.
