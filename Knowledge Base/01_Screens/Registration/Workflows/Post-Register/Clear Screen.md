...
- [[Screen Object Tab Sequence]] — The tab order that governs keyboard navigation between fields. After the screen clears and resets, the same tab sequence remains in effect for the next registration.
