...
- [[Screen Font Size Configuration]] — Describes how the font size of the Registration screen (Normal vs. Large) is determined by the menu item configuration at the point the screen is opened.
