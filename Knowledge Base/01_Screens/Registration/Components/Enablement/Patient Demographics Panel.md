...
- [[Age Value Validation on Save]] — The Date of Birth field on this panel feeds the server-side Age Value calculation; an invalid result triggers message 4121 at save time.
